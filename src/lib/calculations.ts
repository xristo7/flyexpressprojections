...
export const DRIVER_META: DriverMeta[] = [
  ...
  { key: 'ad_monthly', label: 'Advertising revenue / month', unit: 'UGX', purpose: 'Monthly advertising gross', step: 500 },
  { key: 'central_per_travel', label: 'Central fee per additional travel', unit: 'UGX', purpose: 'Association capture per additional travel (not % of fare)', step: 500 },
