...
export const DRIVER_META: DriverMeta[] = [
  ...
  { key: 'fare', label: 'Passenger fare', unit: 'UGX', purpose: 'Ticket price for additional passenger travels' },
  ...
  { key: 'parcel_fee', label: 'Parcel fee', unit: 'UGX', purpose: 'Fee charged per parcel' },
  ...
  { key: 'luggage_fee', label: 'Luggage fee', unit: 'UGX', purpose: 'Fee per luggage-adopting passenger' },
  ...
  { key: 'outward_fare', label: 'Outward fare (reference)', unit: 'UGX', purpose: 'Reference only — not used in uplift math' },
  { key: 'return_fare', label: 'Return fare', unit: 'UGX', purpose: 'Price applied to incremental return bookings' },
  { key: 'ad_monthly', label: 'Advertising revenue / month', unit: 'UGX', purpose: 'Monthly advertising gross' },
  { key: 'central_per_travel', label: 'Central fee per additional travel', unit: 'UGX', purpose: 'Association capture per additional travel (not % of fare)' },
